...
$payment_mode="SARKMIG";
$course_name="HR Analytics";
$customer_name = "Basant Kumar";
$customer_email="anabtawi86@gmail.com";
$customer_phone="+91345645747";
$customer_address="lalita park laxmi nagar 110092";
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(34 ,5,'# MC000'.$invoice_no.'.',0,1);//end of line
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(34 ,5,$payment_mode.'',0,1);//end of line
$pdf->Cell(110);
$pdf->SetTextColor(0,153,51);
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(130 ,5,$course_name.'',1,0);
$pdf->Cell(25 ,5,'1',1,0);
$pdf->Cell(34 ,5,$course_price.'',1,1,'R');//end of line
...
//output the result
 $pdf->Output();
$file_name="abc";
//$pdf->Output('F','invoice/'.$file_name.'.pdf'); 
?>